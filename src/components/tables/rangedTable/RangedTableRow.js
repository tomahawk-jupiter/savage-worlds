...
const RangedTableRow = ({
  ...
  const handleRemoveWeapon = (weaponName) => {
  ...
  return (
    <tr>
      <td>
        ...
        {page !== "shop" && (
          <sup
            onClick={() => handleRemoveWeapon(weapon.item)}
            className="editBtn"
          >
            Del
          </sup>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    removeWeaponFromInventory: (weaponName) =>
      dispatch({ type: "REMOVE_WEAPON_FROM_INVENTORY", weaponName }),
  };
};

export default connect(null, mapDispatchToProps)(RangedTableRow);
